...
',
  ...
  '%sClick here%s to link your GitLab account' => '%sClick here%s to link your GitLab account',
  ...
  'A popular European banking payment method' => 'A popular European banking payment method',
...
9 digits',
  'AMEMBER-DEVICE-ID header is empty. Server require device registration.' => 'AMEMBER-DEVICE-ID header is empty. Server require device registration.',
...
this is your store API Hash from merchant panel',
  'API Key' => 'API Key',
  'API Key
            Can be created from your Ontraport Account->Administration->Integration' => 'API Key
            Can be created from your Ontraport Account->Administration->Integration',
  'API Key
        Your terminal API key' => 'API Key
        Your terminal API key',
  'API Key
...
please apply for an API key at https://api.blockchain.info/v2/apikey/request/',
  'API Login
        The username of your API user in Splitit system' => 'API Login
        The username of your API user in Splitit system',
  'API Password
        The password of your API user in Splitit system' => 'API Password
        The password of your API user in Splitit system',
  'API Public Key' => 'API Public Key',
  'API Secret' => 'API Secret',
  'API Secret Key' => 'API Secret Key',
  'API Token' => 'API Token',
  'API Token
        Get it from pay.nl' => 'API Token
        Get it from pay.nl',
  'API Username' => 'API Username',
  'API hostname' => 'API hostname',
  'Ability to manage(get/update) user\'s profile information' => 'Ability to manage(get/update) user\'s profile information',
  'Above Form' => 'Above Form',
  'Above Form (Header)' => 'Above Form (Header)',
  'Above Login Form' => 'Above Login Form',
  'Above Signup Form' => 'Above Signup Form',
  'Accept' => 'Accept',
...
will be included into URL to make it unique',
  ...
  'Access Denied. You have no permissions to request %s %s' => 'Access Denied. You have no permissions to request %s %s',
...
Set it to be lifetime',
  ...
  'Access denied' => 'Access denied',
  'Access denied. You don\'t have necessary permissions to make this API call. Permissions required: %s' => 'Access denied. You don\'t have necessary permissions to make this API call. Permissions required: %s',
...
first and last name',
  ...
  'Account number' => 'Account number',
  'Acess denied. Must be logged in to access this resource' => 'Acess denied. Must be logged in to access this resource',
  ...
  'Add Access even if user choose 0 donation amount' => 'Add Access even if user choose 0 donation amount',
  'Add Access if User have this InfusionSoft Tag' => 'Add Access if User have this InfusionSoft Tag',
  'Add Access only if user choose some donation' => 'Add Access only if user choose some donation',
...
to do not choose any products',
  'Add an Access to users created from Aptivada
        When plugin create user it can add an access for each user created from Aptivada' => 'Add an Access to users created from Aptivada
        When plugin create user it can add an access for each user created from Aptivada',
...
(additional to configured on aMember CP -> Setup -> Reward Points)',
  ...
  'Add these tags' => 'Add these tags',
  'Add to Basket' => 'Add to Basket',
  'Add user to a course' => 'Add user to a course',
  'Add user to channels: %s' => 'Add user to channels: %s',
  'Add user to courses' => 'Add user to courses',
  'Add user to these groups' => 'Add user to these groups',
  'Add user\'s avatar from aMember to IPB' => 'Add user\'s avatar from aMember to IPB',
  'Add user\'s avatar from aMember to Moodle' => 'Add user\'s avatar from aMember to Moodle',
...
this user always will be assigned as 2-tier affiliate for all affiliates',
  ...
  'Affiliate Payout - Cash App Username' => 'Affiliate Payout - Cash App Username',
  'Affiliate Payout - Crypto Currency' => 'Affiliate Payout - Crypto Currency',
  'Affiliate Payout - Domestic mobile telephone number' => 'Affiliate Payout - Domestic mobile telephone number',
  ...
  'Affiliate Payout - Wallet' => 'Affiliate Payout - Wallet',
  'Affiliate Payout Amount by User' => 'Affiliate Payout Amount by User',
  'Affiliate Payout Conversion Rate
how many credits affiliate should receive for %s' => 'Affiliate Payout Conversion Rate
how many credits affiliate should receive for %s',
  ...
  'Affiliate already has commission with this user' => 'Affiliate already has commission with this user',
  'Affiliate commission to %s' => 'Affiliate commission to %s',
  'Affiliate commission up to %s' => 'Affiliate commission up to %s',
  'Affiliate generated %d item sales %s' => 'Affiliate generated %d item sales %s',
  'Affiliate generated %d sales %s' => 'Affiliate generated %d sales %s',
  'Affiliate generated %d%s in total sales amount %s' => 'Affiliate generated %d%s in total sales amount %s',
  ...
  'Affiliate has not commission with this user yet' => 'Affiliate has not commission with this user yet',
  'Affiliate info' => 'Affiliate info',
...
You can use %root_url%, %root_surl%, %invoice.%, %product.% and %user.% variables in url eg: %user.login%, %user.email%, %invoice.public_id% etc.',
  ...
  'Agree to' => 'Agree to',
  'Agreement Document
keep empty to use all' => 'Agreement Document
keep empty to use all',
  'Agreement is optional
user can continue without give consent' => 'Agreement is optional
...
Pakistan, Romania, Serbia and Montenegro, Ukraine, or Vietnam',
  ...
  'Allow to change Payment System' => 'Allow to change Payment System',
...
with whole directory - useful to print it' => 'Allow user to download PDF
with whole directory - useful to print it',
  'Allowed Paysystems
            keep empty to allow all enabled' => 'Allowed Paysystems
            keep empty to allow all enabled',
  'Allowed Phone Types
...
such as fixed land line, mobile, VoIP, and invalid phone numbers',
  ...
  'An error happened when we try to validate your request. Please check hints for more details' => 'An error happened when we try to validate your request. Please check hints for more details',
  ...
  'Any product' => 'Any product',
  'Api Key' => 'Api Key',
  'Api2  Registration Form' => 'Api2  Registration Form',
  'Api2 Registration Form' => 'Api2 Registration Form',
  'Api2 User Profile Form' => 'Api2 User Profile Form',
  'App ID
            Can be created from your Ontraport Account->Administration->Integration' => 'App ID
            Can be created from your Ontraport Account->Administration->Integration',
  'Applicant Verification Result' => 'Applicant Verification Result',
  'Application' => 'Application',
  'Application \'%s\' require your permission to perform following actions on your behalf
' => 'Application \'%s\' require your permission to perform following actions on your behalf
',
  'Application \'%s\' require your permission to perform following actions on your behalf
You should allow access only if you trust this application' => 'Application \'%s\' require your permission to perform following actions on your behalf
You should allow access only if you trust this application',
...
if nothing selected, apply discount to all products' => 'Apply Discount to Products
this rule will apply discount only to selected products.
if nothing selected, apply discount to all products',
  'Apply Filter' => 'Apply Filter',
  'Apply Products' => 'Apply Products',
...
apply coupon discount to recurring rebills',
  'Apply to recurring?
apply discount to recurring rebills' => 'Apply to recurring?
apply discount to recurring rebills',
  'Approve MAC' => 'Approve MAC',
  'Aptivada' => 'Aptivada',
  'Aptivada Client ID' => 'Aptivada Client ID',
  ...
  'At least php 7.0 required to run oauth server. Your PHP version is: ' => 'At least php 7.0 required to run oauth server. Your PHP version is: ',
  'Attach File' => 'Attach File',
  'Attachments' => 'Attachments',
  'Attempt to charge invoice before rebill date. (%s)' => 'Attempt to charge invoice before rebill date. (%s)',
  'Attempt to charge invoice that should not be charged anymore' => 'Attempt to charge invoice that should not be charged anymore',
  ...
  'Auto-Capture Feedback' => 'Auto-Capture Feedback',
...
Disable that setting if you want to get user consent about being added to list',
  ...
  'Auto-locking is Disabled' => 'Auto-locking is Disabled',
...
width×height',
  ...
  'Average Payments by User Group' => 'Average Payments by User Group',
...
blind carbon copy allows the sender of a message to conceal the person entered in the Bcc field from the other recipients',
  ...
  'Backblaze storage is not configured' => 'Backblaze storage is not configured',
...
%s accounts against any aMember activity',
  ...
  'Basic User profile information(login, name, email)' => 'Basic User profile information(login, name, email)',
...
new coupons for affiliate will be generated in this batch',
  ...
  'Below Signup Form' => 'Below Signup Form',
...
you can create field for birthday %shere%s, it should have date type',
  ...
  'CC Demo' => 'CC Demo',
  'CSRF Error: state is empty' => 'CSRF Error: state is empty',
  'CSRF Error: state is not correct' => 'CSRF Error: state is not correct',
  ...
  'CSRF protection error - nonce field is invalid or empty' => 'CSRF protection error - nonce field is invalid or empty',
  'CSS Selector for container' => 'CSS Selector for container',
  'CSV File was not specified' => 'CSV File was not specified',
  'Calendar Month Subscription' => 'Calendar Month Subscription',
  'Campaign' => 'Campaign',
  'Can Manage JV Settings' => 'Can Manage JV Settings',
  ...
  'Can not connect to mail account: %s' => 'Can not connect to mail account: %s',
  ...
  'Cancel future recurring payments' => 'Cancel future recurring payments',
  'Cancellation Feedback' => 'Cancellation Feedback',
  'Cancellation Reason' => 'Cancellation Reason',
  'Cancellation Reasons' => 'Cancellation Reasons',
  'Cancelled' => 'Cancelled',
  'Cancelled from Oauth App: %s' => 'Cancelled from Oauth App: %s',
...
Card expiration date - month and year',
  'Card Expire
Credit Card Expiration in format: MMYY' => 'Card Expire
...
is required for Maestro/Solo/Switch credit cards only',
  'Card code is either invalid or already used' => 'Card code is either invalid or already used',
  'Cardholder Name
...
cardholder first and last name, exactly as on the card',
  ...
  'Center' => 'Center',
  'Certificate  .pem file. keep them above/outside your webroot folder' => 'Certificate  .pem file. keep them above/outside your webroot folder',
  'Chain Merchant
...
Given by DOKU, if not using Chain, default value is NA',
  ...
  'Change Coupon Code' => 'Change Coupon Code',
  ...
  'Checkout' => 'Checkout',
  'Checkout ID is empty in invoice' => 'Checkout ID is empty in invoice',
...
You can choose same admin several times to balance tickets accordingly',
  ...
  'Closed' => 'Closed',
  'Code' => 'Code',
  'Code is empty. Please start over' => 'Code is empty. Please start over',
  'Code is invalid' => 'Code is invalid',
  'Coin Payments' => 'Coin Payments',
  'Color' => 'Color',
...
the company name associated with the billing address for the transaction',
  ...
  'Condition' => 'Condition',
  'Condition Products
this rule will apply only to selected products.
if nothing selected, rule will apply to all products' => 'Condition Products
this rule will apply only to selected products.
if nothing selected, rule will apply to all products',
  'Condition Products
this rule will count only selected products to match.
if nothing selected, rule will use all products' => 'Condition Products
this rule will count only selected products to match.
if nothing selected, rule will use all products',
  'Condition Type' => 'Condition Type',
  'Conditional Display' => 'Conditional Display',
  'Conditional Products' => 'Conditional Products',
  'Conditions
...
message may be classified as spam by mistake.' => 'Confirmation link has been sent to your e-mail address.
Please check your mailbox. If you have not received e-mail
within 5 minutes, please check also the \'Spam\' folder - our
message may be classified as spam by mistake.',
  'Confirmation message was sent' => 'Confirmation message was sent',
...
disregard subsequent recurring payments',
  ...
  'Contact Form Submits' => 'Contact Form Submits',
...
these categories will be shown in user\'s menu if user has access to resources in this category. You can uses these categories to organize your content by pages',
  ...
  'Converted prices include VAT' => 'Converted prices include VAT',
  'Copy of' => 'Copy of',
...
If ticked, the shipping cost will be applied as a flat charge to each tangible item, rather than as a flat charge per invoice',
  ...
  'Count of downloads' => 'Count of downloads',
  'Count of product purchase' => 'Count of product purchase',
  'Count of product purchase by payment system breakdown' => 'Count of product purchase by payment system breakdown',
  'Count of signups' => 'Count of signups',
  'Count of user signups' => 'Count of user signups',
  'Countries
keep empty to report all' => 'Countries
...
if you set up some price in credits for this item it will be available in self-service store and user will be able to get this item for credits',
  'Credits Title
            Used as caption of tabs and links displayed on user or admin side' => 'Credits Title
...
Plugin will decline all payment attempts',
  'Declined' => 'Declined',
  'Declined. Received error type:%s error codes: %s' => 'Declined. Received error type:%s error codes: %s',
...
will have access to the sele
(for example all subscriptions expired)',
  'Default Number of Installments allowed
        Comma separated string contains all options to display to shopper in payment wizard.
        If not supplied default configuration will display on merchant from terminal.\\
        Example:
        1,2,3,4' => 'Default Number of Installments allowed
        Comma separated string contains all options to display to shopper in payment wizard.
        If not supplied default configuration will display on merchant from terminal.\\
        Example:
        1,2,3,4',
...
hidden field will be populated with this value',
  ...
  'Default for Recurring' => 'Default for Recurring',
  'Default unchecked
...
Leave unchecked if you want newsletter default to be checked',
  ...
  'Define Merge Fields Integration' => 'Define Merge Fields Integration',
  'Define Tags Integration' => 'Define Tags Integration',
  'Define Tags/Segments Integration' => 'Define Tags/Segments Integration',
  'Delete' => 'Delete',
  'Delete %s' => 'Delete %s',
  ...
  'Detach %s' => 'Detach %s',
  'Detach Affiliate' => 'Detach Affiliate',
  'Detail Page Fields
...
alternative template for detail page',
  ...
  'Device is not registered' => 'Device is not registered',
  ...
  'DigitalOcean Spaces storage is not configured' => 'DigitalOcean Spaces storage is not configured',
...
if this box is checked, login via IP will not work for your account',
  ...
  'Disable social proof popup' => 'Disable social proof popup',
  'Disabled' => 'Disabled',
...
what to do with invocie once user click Disregard link',
  ...
  'Do not Show error if correct coupon code but do not apply to any of selected products' => 'Do not Show error if correct coupon code but do not apply to any of selected products',
  'Do not add any access' => 'Do not add any access',
...
for this field on this form (show it without any conditions)',
  ...
  'Do not pre select first option' => 'Do not pre select first option',
...
This action can\'t be reverted!',
  ...
  'Do you really want to mark this gift voucher as used?' => 'Do you really want to mark this gift voucher as used?',
  'Do you really want to send gift voucher?' => 'Do you really want to send gift voucher?',
...
Product which will be added to user\'s account',
  ...
  'Duplicate Value In Field' => 'Duplicate Value In Field',
  'E-Mail' => 'E-Mail',
  ...
  'E-Mail Preferences' => 'E-Mail Preferences',
  ...
  'Either product or item settings (amount, title, currency) must be passed in request' => 'Either product or item settings (amount, title, currency) must be passed in request',
...
will be sent after last payment',
  ...
  'Email Address Confirmed' => 'Email Address Confirmed',
...
aMember will email a notification to user each time admin responds to a user ticket, user can reply to this message from his mail agent directly, response will be added to ticket automatically' => 'Email Message to User
aMember will email a notification to user each time admin responds to a user ticket, user can reply to this message from his mail agent directly, response will be added to ticket automatically',
  ...
  'Email address was confirmed' => 'Email address was confirmed',
  'Email address was confirmed already' => 'Email address was confirmed already',
  ...
  'Empty response received from API' => 'Empty response received from API',
  'Enable' => 'Enable',
  'Enable API Requests Logging' => 'Enable API Requests Logging',
  'Enable Debug Log' => 'Enable Debug Log',
  'Enable Dime Sale' => 'Enable Dime Sale',
  'Enable Ecommerce Tracking' => 'Enable Ecommerce Tracking',
...
aMember will require two peices of location evidence before an invoice is created. Invoice that fials validation will be blocked and user will receive warning.',
  'Enable Manual Rebill Support
            Allow for user to complete rebill manually if automatic rebill failed for some reason' => 'Enable Manual Rebill Support
            Allow for user to complete rebill manually if automatic rebill failed for some reason',
  'Enable PDF Invoice
...
',
  ...
  'Enquires' => 'Enquires',
  'Enquiries' => 'Enquiries',
  'Enquiry Message to Admin' => 'Enquiry Message to Admin',
  'Enquiry Message to User' => 'Enquiry Message to User',
  'Enter ID generated by software' => 'Enter ID generated by software',
  'Enter coupon code' => 'Enter coupon code',
  'Enter either your email address or username and we will send you a link to reset your password.' => 'Enter either your email address or username and we will send you a link to reset your password.',
...
if this box is checked, you will not be displayed in public members directory',
  ...
  'Expiration Notification
        User will be notified about product expiration 3 days before expire,
        In template you can use %user.% and %product.% placeholders' => 'Expiration Notification
        User will be notified about product expiration 3 days before expire,
        In template you can use %user.% and %product.% placeholders',
  'Expire' => 'Expire',
...
By default all enabled paysystems will be listed',
  ...
  'Field should match this regex: %s' => 'Field should match this regex: %s',
  'Fields' => 'Fields',
...
keep empty to report all files',
  ...
  'Files located on Backblaze storage' => 'Files located on Backblaze storage',
  'Files located on DigitalOcean Spaces storage. (Warning: Your buckets should not contain letters in uppercase in its name)' => 'Files located on DigitalOcean Spaces storage. (Warning: Your buckets should not contain letters in uppercase in its name)',
  'Files located on Selectel storage. ' => 'Files located on Selectel storage. ',
  'Files located on Wasabi Cloud Storage. (Warning: Your buckets should not contain letters in uppercase in its name)' => 'Files located on Wasabi Cloud Storage. (Warning: Your buckets should not contain letters in uppercase in its name)',
  'Files located on pCloud storage. (Warning: Your buckets should not contain letters in uppercase in its name)' => 'Files located on pCloud storage. (Warning: Your buckets should not contain letters in uppercase in its name)',
  ...
  'First Time Affiliate Sale: %s' => 'First Time Affiliate Sale: %s',
  'First Time Purchase(or get for free) the Product' => 'First Time Purchase(or get for free) the Product',
  ...
  'Flexible Actions' => 'Flexible Actions',
  ...
  'Follow this link to complete subscription payment manually: %s' => 'Follow this link to complete subscription payment manually: %s',
  'Font
...
this content will be included to footer',
  ...
  'Form is not configured' => 'Form is not configured',
  'Form will be used to validate user profile update request through /api2/user/profile endpoint' => 'Form will be used to validate user profile update request through /api2/user/profile endpoint',
  'Form will be used to validate user registration request through /api2/register endpoint' => 'Form will be used to validate user registration request through /api2/register endpoint',
  'Forum' => 'Forum',
  'Free' => 'Free',
  ...
  'Full Name' => 'Full Name',
  'Full Path to aMember Pro files on server' => 'Full Path to aMember Pro files on server',
  'Full profile information, with address info' => 'Full profile information, with address info',
  'G2A supports only 1 months subscirptions' => 'G2A supports only 1 months subscirptions',
  'GST (Inclusive Tax)' => 'GST (Inclusive Tax)',
  'Gateway: Create/Get info about payment  session' => 'Gateway: Create/Get info about payment  session',
  'Generated' => 'Generated',
  'Get Link' => 'Get Link',
  'Get List of current agreement documents' => 'Get List of current agreement documents',
  'Get Newsletter Lists Available for Subscribe' => 'Get Newsletter Lists Available for Subscribe',
  'Get Password' => 'Get Password',
  'Get Payment Link' => 'Get Payment Link',
  'Get affiliate coupons' => 'Get affiliate coupons',
  'Get information about access records' => 'Get information about access records',
  'Get products available for purchase' => 'Get products available for purchase',
  'Get single record' => 'Get single record',
  'Get user\'s current newsletter subscriptions. Subscribe/Unsubscribe lists' => 'Get user\'s current newsletter subscriptions. Subscribe/Unsubscribe lists',
  'Get/Delete user personal data' => 'Get/Delete user personal data',
  'Get/set user consent' => 'Get/set user consent',
  'GetClicky Site Id
...
empty or 0 - without limit',
  ...
  'Got error from Gitlab: %s' => 'Got error from Gitlab: %s',
  'Got incorrect response from  GitLab, please try again later' => 'Got incorrect response from  GitLab, please try again later',
  'Grantor' => 'Grantor',
...
in this list as "Primary"',
  ...
  'Has Same First and Last Name' => 'Has Same First and Last Name',
  'Has Used Payment System' => 'Has Used Payment System',
  'Has User Note' => 'Has User Note',
  ...
  'Have Number of Active Subscriptions to Product(s)' => 'Have Number of Active Subscriptions to Product(s)',
...
keep it empty for default value',
  ...
  'Header Menu Items
you can edit items that appear in user menu' => 'Header Menu Items
...
but it will not be available on signup/renewal  forms' => 'Hide this Payment System
That action will hide the payment system from the list of available payment plugins
Payment system will work still, all recurring payments will be handled,
but it will not be available on signup/renewal  forms',
  'Hide widget with Personal Content from User Dashboard' => 'Hide widget with Personal Content from User Dashboard',
  'History' => 'History',
  'Holded API Key' => 'Holded API Key',
  'Holded Channel ID' => 'Holded Channel ID',
  'Holded Product ID' => 'Holded Product ID',
  'Hooks are not set, check error log for details' => 'Hooks are not set, check error log for details',
  'Host' => 'Host',
  'Hosted Mode
Display payment overlay instead of redirect' => 'Hosted Mode
Display payment overlay instead of redirect',
  'Hosted at Activecampaign\'s server' => 'Hosted at Activecampaign\'s server',
...
used for placeholders in emails',
  ...
  'Icon' => 'Icon',
  'Identity Block Position' => 'Identity Block Position',
  'Identity Type
what you want to display in identity block' => 'Identity Type
...
Send alert if user didn\'t login in XX days',
  ...
  'Include Only Paid Invoices' => 'Include Only Paid Invoices',
  'Include only users who have active subscriptions to these products' => 'Include only users who have active subscriptions to these products',
...
in case of empty all active users will be included',
  ...
  'Incorrect format of MAC address' => 'Incorrect format of MAC address',
  'Incorrect response received from apple.com: %s' => 'Incorrect response received from apple.com: %s',
  'Index Page Fields' => 'Index Page Fields',
  'Information about active subscirptions and access expiration dates' => 'Information about active subscirptions and access expiration dates',
  'Information about manual rebill link, if applicable' => 'Information about manual rebill link, if applicable',
  'Information about next billing attempt, if applicable' => 'Information about next billing attempt, if applicable',
  'Information about resources available to user on site(protected folders, files, videos)' => 'Information about resources available to user on site(protected folders, files, videos)',
  'Information block
        Text will be displayed on verification screen' => 'Information block
        Text will be displayed on verification screen',
  'Information/permissions requested' => 'Information/permissions requested',
...
Lead time required to setup a new mandate, this is usually 12 days.' => 'Initial Lead Time (days)
Lead time required to setup a new mandate, this is usually 12 days.',
...
email will contain this sentence' => 'Insert comment into email
email will contain this sentence',
  ...
  'Intro Text on Page with Personal Downloads' => 'Intro Text on Page with Personal Downloads',
  ...
  'Invite Message
        In order to invite user into channel plugin will send message to user directly
        you can use these placeholders in message: %link% - invoice link, %user.% any user variable' => 'Invite Message
        In order to invite user into channel plugin will send message to user directly
        you can use these placeholders in message: %link% - invoice link, %user.% any user variable',
...
This text will be included at bottom to PDF Invoice. You can use all user specific placeholders here eg. %user.login%, %user.name_f%, %user.name_l% etc.',
  'Invoice ID is missing in incoming request' => 'Invoice ID is missing in incoming request',
  'Invoice Internal ID#' => 'Invoice Internal ID#',
  'Invoice Number: ' => 'Invoice Number: ',
  'Invoice Public ID#' => 'Invoice Public ID#',
  'Invoice Rebill Date' => 'Invoice Rebill Date',
  ...
  'Invoice was already set' => 'Invoice was already set',
  'Invoices By Signup Form' => 'Invoices By Signup Form',
...
customer / affiliate status',
  ...
  'Is Gift Voucher?
check it if you want to gift subscription on this product' => 'Is Gift Voucher?
...
it will be injected on signup form',
  ...
  'Key .pem file. keep them above/outside your webroot folder' => 'Key .pem file. keep them above/outside your webroot folder',
...
keep it empty for unlimited',
  ...
  'Limit verification for Payment Systems
        verification will be enabled only for selected payment systems
        if nothing selected, verification will be enabled for all payment systems
        ' => 'Limit verification for Payment Systems
        verification will be enabled only for selected payment systems
        if nothing selected, verification will be enabled for all payment systems
        ',
  'Line Created to User' => 'Line Created to User',
  ...
  'Link your GitLab Account' => 'Link your GitLab Account',
  'Link/URL' => 'Link/URL',
  'Linked Account: %s' => 'Linked Account: %s',
...
alternative template for list page',
  ...
  'List/search for records' => 'List/search for records',
  'Lists
...
Some scripts have special group for this situations: \'Unregistered\' or \'Guest\'',
  'Locked Role
Whenever user is  locked in aMember, 
plugin adds user to this role in Kayako 
Select any role with limited access which doesn\'t allow to login into Kayako
Some scripts have special group for this situations: \'Unregistered\' or \'Guest\'' => 'Locked Role
Whenever user is  locked in aMember, 
plugin adds user to this role in Kayako 
Select any role with limited access which doesn\'t allow to login into Kayako
Some scripts have special group for this situations: \'Unregistered\' or \'Guest\'',
  ...
  'Login Form Type' => 'Login Form Type',
  ...
  'Login with Sidebar' => 'Login with Sidebar',
  'Logo Image
keep it empty for default value' => 'Logo Image
keep it empty for default value',
  'Logo Position' => 'Logo Position',
  'Logo Width' => 'Logo Width',
  'Logo on Login Form
keep it empty if none' => 'Logo on Login Form
keep it empty if none',
  'Logout' => 'Logout',
  'Lost Password Sending Error' => 'Lost Password Sending Error',
  'Lost Password Sent' => 'Lost Password Sent',
  'Lost password?' => 'Lost password?',
  'Low Level Threshold' => 'Low Level Threshold',
  'Low Level User Notification' => 'Low Level User Notification',
...
API key can be obtained from Integrations page when you are logged into MailerLite application',
  ...
  'Malformed of bad request was received' => 'Malformed of bad request was received',
  ...
  'Manage user\'s invoices' => 'Manage user\'s invoices',
  ...
  'Match Signup Date' => 'Match Signup Date',
  'Match Signup Date and Time' => 'Match Signup Date and Time',
  'Max' => 'Max',
  ...
  'Maximum number of days when the charge can be accepted
default is zero, maximum is 29' => 'Maximum number of days when the charge can be accepted
...
%sObtain a Free or Premium license key%s',
  'Mechant Password
Merchant Id issued in the Gateway System 
(not to be confused with the Control Panel username)' => 'Mechant Password
Merchant Id issued in the Gateway System 
(not to be confused with the Control Panel username)',
  ...
  'Menu' => 'Menu',
  'Menu Items
you can edit items that appear in user menu' => 'Menu Items
you can edit items that appear in user menu',
  'Merchant Code
...
Use demo for testing',
  'Merchant ID assigned by WeChat Payment
        Example：1900000109' => 'Merchant ID assigned by WeChat Payment
        Example：1900000109',
  ...
  'Merchant identifier you created in your apple developer account' => 'Merchant identifier you created in your apple developer account',
  'Message' => 'Message',
  'Message
...
include to report only affiliates with payout in qiven period more or equal to',
  'Minimum Quantity to Purchase' => 'Minimum Quantity to Purchase',
...
keep it empty if there is not any limit',
  'Misc' => 'Misc',
  'Missing parameter: invoice_id' => 'Missing parameter: invoice_id',
  'Mode' => 'Mode',
...
first and last name',
  ...
  'New Feedback to Admin' => 'New Feedback to Admin',
...
must be %d or more characters',
  ...
  'New Serial to User' => 'New Serial to User',
...
Send message only if user is subscribed to any newsletter from list',
  ...
  'Newsletters Flexible' => 'Newsletters Flexible',
  'Next' => 'Next',
  ...
  'No Labels' => 'No Labels',
  'No Layout' => 'No Layout',
  'No checkout ID was returned' => 'No checkout ID was returned',
  ...
  'No redirect Url  was returned' => 'No redirect Url  was returned',
...
Enable %sTelephone Number Identification (TNI)%s service',
  ...
  'Number of payment in invoice %s %d' => 'Number of payment in invoice %s %d',
  ...
  'OAuth Client ID
Client ID that should be used to make API request from JS
' => 'OAuth Client ID
Client ID that should be used to make API request from JS
',
  'OAuth2 server: Can Add/remove access tokens' => 'OAuth2 server: Can Add/remove access tokens',
  'OAuth2 server: Can add/delete/edit clients' => 'OAuth2 server: Can add/delete/edit clients',
  'OK' => 'OK',
  ...
  'Oauth 2 Server' => 'Oauth 2 Server',
  'Offer Page Settings' => 'Offer Page Settings',
  'Official Account ID assigned by WeChat
        Example：wx8888888888888888' => 'Official Account ID assigned by WeChat
  ...
  'Old Value' => 'Old Value',
  'On add
action to execute once a user appears in the search' => 'On add
action to execute once a user appears in the search',
  'On delete
action to execute once a user disappears from the search' => 'On delete
action to execute once a user disappears from the search',
...
a record on %saMember CP -> Protect Content -> Newsletters%s page',
  ...
  'Online' => 'Online',
  'Online Bank Transfers' => 'Online Bank Transfers',
  ...
  'Ontraport Product' => 'Ontraport Product',
  'Open Link in New Window' => 'Open Link in New Window',
  'OpenNode API Key' => 'OpenNode API Key',
  ...
  'Package Name
            The package name of the application the inapp product was sold in (for example, "com.some.thing").' => 'Package Name
            The package name of the application the inapp product was sold in (for example, "com.some.thing").',
  'Paddle ID' => 'Paddle ID',
  'Paddle approved the high risk payment. User account reenabled.' => 'Paddle approved the high risk payment. User account reenabled.',
  'Paddle flagged a recent payment by this user as high risk (%s chance of fraud). User account disabled.' => 'Paddle flagged a recent payment by this user as high risk (%s chance of fraud). User account disabled.',
  'Paddle rejected the high risk payment. User account disabled.' => 'Paddle rejected the high risk payment. User account disabled.',
  ...
  'Panel URL
it is dns (Domain Name) and port of your Streaming Server (Streaming Server -> Manage Servers)' => 'Panel URL
it is dns (Domain Name) and port of your Streaming Server (Streaming Server -> Manage Servers)',
...
calculated for first payment in each invoice',
  ...
  'Password is missing in incoming request' => 'Password is missing in incoming request',
  ...
  'Password you used to create key.pem' => 'Password you used to create key.pem',
...
Leave default value if you are not sure',
  ...
  'Payment System: %s' => 'Payment System: %s',
  'Payment Systems
keep empty to report all' => 'Payment Systems
keep empty to report all',
  'Payment Token is empty' => 'Payment Token is empty',
  'Payment Type' => 'Payment Type',
  'Payment error: ' => 'Payment error: ',
  'Payment failed' => 'Payment failed',
  'Payment failed: %s' => 'Payment failed: %s',
  'Payment info' => 'Payment info',
  'Payment intent is empty' => 'Payment intent is empty',
  'Payment method is empty' => 'Payment method is empty',
  'Payment refund' => 'Payment refund',
  'Payments' => 'Payments',
  'Payments Amount' => 'Payments Amount',
  'Payments Distribution by Customer Country' => 'Payments Distribution by Customer Country',
  ...
  'Payments by User Group' => 'Payments by User Group',
  ...
  'Paysystem NOT IN (%s)' => 'Paysystem NOT IN (%s)',
  'Paysystem is empty in invoice.' => 'Paysystem is empty in invoice.',
...
when sale will be added to notification,
 default is to add all sales from past 2 hours',
  ...
  'Period of Bonus subscription that will be added' => 'Period of Bonus subscription that will be added',
...
These files will be available for downloads only for this user on his dashboard',
  ...
  'Personal Data Delete is disabled in config' => 'Personal Data Delete is disabled in config',
  ...
  'Please enter both First and Last names' => 'Please enter both First and Last names',
  ...
  'Please enter either login or email' => 'Please enter either login or email',
  ...
  'Please fill out %sthis form%s to get a new one!' => 'Please fill out %sthis form%s to get a new one!',
  'Please install SSL if you are using affiliate links with redirect to other domains' => 'Please install SSL if you are using affiliate links with redirect to other domains',
...
you still can signup again as new user.',
  ...
  'Please wait %s until next attempt' => 'Please wait %s until next attempt',
...
user should have active access to one of following products in order to personal folder was created',
  'Product %s is added to your account.' => 'Product %s is added to your account.',
...
displayed on the shopping cart page',
  ...
  'Product ID is incorrect. Integer value is required' => 'Product ID is incorrect. Integer value is required',
...
leave it empty to include all products',
  ...
  'Products are missing in incoming request' => 'Products are missing in incoming request',
  ...
  'Protect User Groups' => 'Protect User Groups',
...
you need to save new categories before it appear in this list',
  ...
  'Publish' => 'Publish',
  'Publish Date
set it if you want to grant lifetime access to this item for users with active subscription on this date' => 'Publish Date
set it if you want to grant lifetime access to this item for users with active subscription on this date',
  'Purchase' => 'Purchase',
  'Purchased %s with %s = %s' => 'Purchased %s with %s = %s',
  'Purchased Credits' => 'Purchased Credits',
  'Purchased product with option' => 'Purchased product with option',
  'Qty' => 'Qty',
  'Quantity' => 'Quantity',
  'Quarter' => 'Quarter',
...
register of answers does not matter',
  ...
  'Rate' => 'Rate',
  'Rating' => 'Rating',
  'Rating Element Style' => 'Rating Element Style',
  'Re-Open Ticket' => 'Re-Open Ticket',
  'Read All Notifications' => 'Read All Notifications',
  'Read-only' => 'Read-only',
  'Real Path' => 'Real Path',
  'Reason' => 'Reason',
  'Rebill Lead Time (days)
Lead time required to rebilling charge instructions, this is usually 5 days.' => 'Rebill Lead Time (days)
Lead time required to rebilling charge instructions, this is usually 5 days.',
  'Rebuild' => 'Rebuild',
  ...
  'Rebuild...' => 'Rebuild...',
  'Receipt Status is  not success: %s' => 'Receipt Status is  not success: %s',
...
For example: INV-%year%-',
  'Received 3DSecure redirect response, but no redirect link' => 'Received 3DSecure redirect response, but no redirect link',
  'Received from Oauth App: %s' => 'Received from Oauth App: %s',
  'Received password is not the same as stored in config' => 'Received password is not the same as stored in config',
...
If empty, [Admin E-Mail Address] is used' => 'Recipient (Email Address)
If empty, [Admin E-Mail Address] is used',
...
you can use user specific placeholders in url %user.*% eg.: %user.email%, %user.login% etc.',
  ...
  'Refund Receipt Id' => 'Refund Receipt Id',
...
For example: RFND-%year%-',
  ...
  'Refund was registered. It will be added to invoice record from callback. Click cancel to close this window' => 'Refund was registered. It will be added to invoice record from callback. Click cancel to close this window',
  'Refunded' => 'Refunded',
  'Refunds Distribution by Customer Country' => 'Refunds Distribution by Customer Country',
...
You won\'t be prompted for 2-factor authentication when you login from this device',
  'Remita Service Type ID' => 'Remita Service Type ID',
  'Remote API Permissions' => 'Remote API Permissions',
  'Remote Addr (IP)' => 'Remote Addr (IP)',
  'Remove' => 'Remove',
  'Remove Files from User Accounts' => 'Remove Files from User Accounts',
  'Remove Header from Login Page' => 'Remove Header from Login Page',
...
action after new invoice completed',
  ...
  'Remove Personal Content Files' => 'Remove Personal Content Files',
  'Remove Users
...
By default the service uses the highest level available',
  'Require Active Consent' => 'Require Active Consent',
  'Require Active Consent
        ...
        it will be asked when user login' => 'Require Active Consent
        Depends on selected rules, user must have active consent to current document type
        If user doesn\'t have active consent to current document,
...
leave empty to reset for all users',
  ...
  'Resolve User Addresses' => 'Resolve User Addresses',
  'Responsive' => 'Responsive',
  'Restore All Users' => 'Restore All Users',
  'Restore User' => 'Restore User',
  'Resume Subscription' => 'Resume Subscription',
  'Resume cancelled or failed subscription' => 'Resume cancelled or failed subscription',
  'Retention Rate' => 'Retention Rate',
  'Retrieve list of enabled payment system' => 'Retrieve list of enabled payment system',
  'Retry On Failure
...
instructions for search engines',
  'Roles Priority
you may drag and drop roles to sort it.
if there are several roles available for user
aMember will choose role that are higher
in this list as "Primary"' => 'Roles Priority
you may drag and drop roles to sort it.
if there are several roles available for user
aMember will choose role that are higher
in this list as "Primary"',
...
empty - it uses global settings',
  ...
  'Run action: %s' => 'Run action: %s',
  'Running %s' => 'Running %s',
  'SEPA Direct Debit' => 'SEPA Direct Debit',
  'Sales' => 'Sales',
  'Sales Notification Disabled' => 'Sales Notification Disabled',
  'Sandbox' => 'Sandbox',
  'Save' => 'Save',
  'Save As Preset
...
Terms will be changed by cron once an hour',
  ...
  'Security Key
        For direct post API' => 'Security Key
        For direct post API',
  'Security code is invalid' => 'Security code is invalid',
  'Security error. Invoice is related to another user.' => 'Security error. Invoice is related to another user.',
  ...
  'Send Date' => 'Send Date',
  'Send Delay
Send email to user with offer to leave feedback after XX days after product purchase' => 'Send Delay
Send email to user with offer to leave feedback after XX days after product purchase',
...
MD5 Hash method bypasses all blacklists, normalisation and obfuscation bypass checks',
  ...
  'Send Email to User
and ask for feedback' => 'Send Email to User
and ask for feedback',
  ...
  'Send Gift Card to Recipient (Admin Added)' => 'Send Gift Card to Recipient (Admin Added)',
  'Send Gift Card to Recipient (User Purchased)' => 'Send Gift Card to Recipient (User Purchased)',
  'Send Gift Voucher' => 'Send Gift Voucher',
...
default email template',
  ...
  'Send Refund Admin' => 'Send Refund Admin',
  'Send Refund Mail' => 'Send Refund Mail',
...
if coupon batch is almost empty',
  ...
  'Send Voucher To
after completing order, voucher will be sent to specified address if not specified, voucher will be sent to your email' => 'Send Voucher To
after completing order, voucher will be sent to specified address if not specified, voucher will be sent to your email',
  'Send confirmation email to user/confirm email address' => 'Send confirmation email to user/confirm email address',
...
keep empty to send all users',
  ...
  'Sending' => 'Sending',
  'Sendy API key
        Your API key can be obtained from your main settings' => 'Sendy API key
...
available in the member area for customers',
  ...
  'Set roles: %s' => 'Set roles: %s',
  'Settings' => 'Settings',
  'Settings saved successfully' => 'Settings saved successfully',
  'Setup Store' => 'Setup Store',
  'Setup charge on invoice object' => 'Setup charge on invoice object',
  'Share Same Signup IP with other users' => 'Share Same Signup IP with other users',
  'Shared Key
...
Unique Shop ID in the system',
  ...
  'Show' => 'Show',
  'Show &quot;Link Account&quot; only if user has required products' => 'Show &quot;Link Account&quot; only if user has required products',
  'Show Billing Address Info
                Display billing address info fields on CC info page' => 'Show Billing Address Info
  ...
  'Show Plans in Product Grid
If checked, the plugin will add a column to the Manage Products grid' => 'Show Plans in Product Grid
If checked, the plugin will add a column to the Manage Products grid',
  ...
  'Shown if User is LOGGED IN' => 'Shown if User is LOGGED IN',
  'Sidebar' => 'Sidebar',
  ...
  'Signup Form
keep empty to report all' => 'Signup Form
keep empty to report all',
...
in case of user already have access to this product',
  'Skip this block if there is not any purchase options' => 'Skip this block if there is not any purchase options',
...
0-255',
  ...
  'State is empty. Please start over' => 'State is empty. Please start over',
  'Statistics' => 'Statistics',
  'Status' => 'Status',
  'Status is not succeeded' => 'Status is not succeeded',
  ...
  'Stripe EFW notification received for user payment  %s. Payment refunded. User disabled' => 'Stripe EFW notification received for user payment  %s. Payment refunded. User disabled',
  ...
  'Submit recurring payment for this subscription manually' => 'Submit recurring payment for this subscription manually',
  'Subscirption Cancelled' => 'Subscirption Cancelled',
  'Subscirption expired' => 'Subscirption expired',
  'Subscribe' => 'Subscribe',
  ...
  'Subscribed from Oauth App: %s' => 'Subscribed from Oauth App: %s',
  ...
  'Subscription first period will be calculated in a way
            so user always will be rebilled by 1st of next month.
            Access always will be added from 1st of current month til the end of current month. ' => 'Subscription first period will be calculated in a way
            so user always will be rebilled by 1st of next month.
            Access always will be added from 1st of current month til the end of current month. ',
...
it will be removed when aMember updates user account',
  ...
  'Tag Users In Zendesk' => 'Tag Users In Zendesk',
  'Tag Users [%s]' => 'Tag Users [%s]',
  'Tags' => 'Tags',
  'Tags
comma separated list of tags' => 'Tags
comma separated list of tags',
  'Tags Controlled By aMember
        Tags selected there will be removed from user\'s account 
        when user\'s subscription expires ' => 'Tags Controlled By aMember
        Tags selected there will be removed from user\'s account 
...
for example 18.5 (no percent sign)',
  ...
  'Telegram Bot login' => 'Telegram Bot login',
  'Telegram Channel ID
Specify channel id here only if you want to add all active users to this channel regardless of exact product, otherwise you need to set channel id within settings of corresponding product' => 'Telegram Channel ID
Specify channel id here only if you want to add all active users to this channel regardless of exact product, otherwise you need to set channel id within settings of corresponding product',
  'Telegram bot key' => 'Telegram bot key',
  'Template' => 'Template',
  'Terminal Key

        A unique identification string assigned to the terminal identifier.' => 'Terminal Key

        A unique identification string assigned to the terminal identifier.',
  'Terminal Number
...
which is assigned by its bank. The default value “001”.3 is considered its maximum length',
  ...
  'Test Discount Rules' => 'Test Discount Rules',
  'Test Mode' => 'Test Mode',
  'Test Mode
' => 'Test Mode
',
...
The cents part of the amount you pass to DirectOne will determine the response code for the test script. For example, an amount of 100 ($1.00) with return a response of 00 which represents an approved transaction response. An amount of 151 ($1.51) will return a response of 51 which represents a declined transaction response.',
  ...
  'Test notification was received but test mode is not enabled' => 'Test notification was received but test mode is not enabled',
  'Text' => 'Text',
...
This text will be included at bottom to PDF file. You can use all user specific placeholders here eg. %user.login%, %user.name_f%, %user.name_l% etc.',
  ...
  'Thanks for contacting us! Your message has been received! We will respond to you as soon as possible.' => 'Thanks for contacting us! Your message has been received! We will respond to you as soon as possible.',
  ...
  'The minimum quantity to purchase for %s is %d' => 'The minimum quantity to purchase for %s is %d',
  ...
  'The requested object was not found' => 'The requested object was not found',
  ...
  'There is a pending request to change your email to <strong>%s</strong>. Please check your email (including your spam) and click the link to confirm the change.' => 'There is a pending request to change your email to <strong>%s</strong>. Please check your email (including your spam) and click the link to confirm the change.',
  'There is issue with second factor Authentication. Please wait %s until next attempt' => 'There is issue with second factor Authentication. Please wait %s until next attempt',
  ...
  'This MAC address is already in use' => 'This MAC address is already in use',
  ...
  'This functionality is not implemented' => 'This functionality is not implemented',
  'This is a required field' => 'This is a required field',
  'This link is either invalid or expired' => 'This link is either invalid or expired',
  'This offer is expired' => 'This offer is expired',
  'This order was processed by our online reseller & Merchant of Record, Paddle.com, who also handle order related inquiries and returns. The payment will appear on your bank/card statement as:' => 'This order was processed by our online reseller & Merchant of Record, Paddle.com, who also handle order related inquiries and returns. The payment will appear on your bank/card statement as:',
  ...
  'This product is either not exist or you already have it.' => 'This product is either not exist or you already have it.',
  ...
  'Ticket has been submitted' => 'Ticket has been submitted',
  'Tickets' => 'Tickets',
  'Tier' => 'Tier',
  'Title' => 'Title',
  'Title
...
To make form multi-page, insert \'Form Page Break\' item into the place where you want page to be split.' => 'To add fields into the form, move item from \'Available Bricks\' to \'Form Bricks\'.
To remove fields, move it back to \'Available Bricks\'.
To make form multi-page, insert \'Form Page Break\' item into the place where you want page to be split.',
  'To complete payment scan below QRCode with your WeChat app' => 'To complete payment scan below QRCode with your WeChat app',
  'To see what Personal Data we have, click %sthis link%s.' => 'To see what Personal Data we have, click %sthis link%s.',
  'Today' => 'Today',
  'Toggle Password Visibility' => 'Toggle Password Visibility',
  'Token Code
        Get it from pay.nl' => 'Token Code
        Get it from pay.nl',
  'Token Payments are not supported by payment system' => 'Token Payments are not supported by payment system',
  'Token is empy in response object' => 'Token is empy in response object',
  'Token is not correct. Unable to get info about bot' => 'Token is not correct. Unable to get info about bot',
...
for recurring subscription aMember notify iDevAffiliate only about initial payment',
  'Tracking/Widget Code' => 'Tracking/Widget Code',
  'Transaction Declined' => 'Transaction Declined',
  'Transaction Failed' => 'Transaction Failed',
  'Transaction Failed: %s (RRR: %s)' => 'Transaction Failed: %s (RRR: %s)',
  'Transaction aborted by user.' => 'Transaction aborted by user.',
  'Transaction failed' => 'Transaction failed',
  'Transaction is being processed by API at the moment' => 'Transaction is being processed by API at the moment',
  'Transaction reference: %s' => 'Transaction reference: %s',
  'Transaction status is not success' => 'Transaction status is not success',
  'Transaction was processed already' => 'Transaction was processed already',
...
if user has paid subscirption to a channel',
  ...
  'Type Keyword to search…' => 'Type Keyword to search…',
  'Type Username or E-Mail' => 'Type Username or E-Mail',
  'Type a keyword to search in FAQ' => 'Type a keyword to search in FAQ',
  'Type to Filter…' => 'Type to Filter…',
  'URL' => 'URL',
  'US Legal Landscape' => 'US Legal Landscape',
  'US Legal Portrait' => 'US Legal Portrait',
  'US Letter Landscape' => 'US Letter Landscape',
  'US Letter Portrait' => 'US Letter Portrait',
  ...
  'Unable to contact apple.com to validate receipt' => 'Unable to contact apple.com to validate receipt',
  ...
  'Unable to create payment: %s' => 'Unable to create payment: %s',
  'Unable to create/update user. Got an error: %s' => 'Unable to create/update user. Got an error: %s',
  ...
  'Unable to fetch invoice record' => 'Unable to fetch invoice record',
  'Unable to fetch your twitch account information!' => 'Unable to fetch your twitch account information!',
  'Unable to find current version of document for this type' => 'Unable to find current version of document for this type',
  'Unable to find invoice' => 'Unable to find invoice',
  'Unable to find session' => 'Unable to find session',
  'Unable to get information from discord: %s' => 'Unable to get information from discord: %s',
  'Unable to get token' => 'Unable to get token',
  'Unable to handle invoice, class: %s undefined' => 'Unable to handle invoice, class: %s undefined',
  'Unable to initialize payment' => 'Unable to initialize payment',
  'Unable to load invoice object' => 'Unable to load invoice object',
  'Unable to load invoice record' => 'Unable to load invoice record',
  'Unable to load user associated with license' => 'Unable to load user associated with license',
  'Unable to process charge: %s' => 'Unable to process charge: %s',
  ...
  'Unable to set paysystem: %s' => 'Unable to set paysystem: %s',
  'Unable to start payment' => 'Unable to start payment',
  'Unable to unsubscribe user from newsletter list "%s" : %s' => 'Unable to unsubscribe user from newsletter list "%s" : %s',
  'Unable to validate invoice record' => 'Unable to validate invoice record',
  'Unable to validation coupon code' => 'Unable to validation coupon code',
  ...
  'Unsubscribed from Oauth App: %s' => 'Unsubscribed from Oauth App: %s',
  ...
  'Update Credit Card Information for this subscription' => 'Update Credit Card Information for this subscription',
...
Plugin will update your Infusion Contact with autogenerated username/password',
  ...
  'Upload Personal Content Files' => 'Upload Personal Content Files',
...
enable this option if you use https for your site',
  'Use Stripe Checkout to collect Payment information
...
use custom host, user, password for %s database connectionUsually you can leave this unchecked',
  ...
  'User Agent (Browser & device)' => 'User Agent (Browser & device)',
...
Rule will be applied only if user meet conditions',
  ...
  'User Distribution by Custom Field by Date' => 'User Distribution by Custom Field by Date',
  'User Email' => 'User Email',
  'User First Name' => 'User First Name',
  'User Gravatar in user identity block' => 'User Gravatar in user identity block',
  'User Group' => 'User Group',
  'User Groups' => 'User Groups',
  'User Groups
keep empty to include all groups to report' => 'User Groups
keep empty to include all groups to report',
  'User Groups
user can opt-in to selected groups,
 keep empty to make all user groups selectable' => 'User Groups
user can opt-in to selected groups,
 keep empty to make all user groups selectable',
  ...
  'User Menu Items
you can edit items that appear in user menu' => 'User Menu Items
you can edit items that appear in user menu',
  'User Personal Folder URL' => 'User Personal Folder URL',
  'User Phone' => 'User Phone',
  'User Search' => 'User Search',
  'User Secret Key
            Please login to Toyyibpay to get User Secret Key' => 'User Secret Key
            Please login to Toyyibpay to get User Secret Key',
...
agreement state will be recorded to invoice instead of user',
  ...
  'User should have/had access on publish date exactly' => 'User should have/had access on publish date exactly',
...
Take into Account only user who sign up in defined period, keep empty to use all user',
  'Users by User Groups' => 'Users by User Groups',
  'Users created from Aptivada' => 'Users created from Aptivada',
...
Free invoices won\'t be validated still',
  ...
  'Venmo' => 'Venmo',
  'Verification Flow
            What information do you require to verify user' => 'Verification Flow
            What information do you require to verify user',
  'Verification Flow ID
            Create verification flow at your
            Sum&Sub Account Dashboard-> Integrations -> Verification Flow,
            and specify ID of that flow. If empty aMember will use default flow: basic-kyc' => 'Verification Flow ID
            Create verification flow at your
            Sum&Sub Account Dashboard-> Integrations -> Verification Flow,
            and specify ID of that flow. If empty aMember will use default flow: basic-kyc',
  ...
  'Wasabi Cloud Storage is not configured' => 'Wasabi Cloud Storage is not configured',
  'Watchers' => 'Watchers',
  'Watchers
...
notify the following admins about new messages in this ticket',
  ...
  'Webhook Secret
        must be the same as in your account' => 'Webhook Secret
        must be the same as in your account',
  'Webhooks' => 'Webhooks',
  'Website ID
Merchant Id issued in the Gateway System 
(not to be confused with the Control Panel username)' => 'Website ID
Merchant Id issued in the Gateway System 
(not to be confused with the Control Panel username)',
  ...
  'Wrong code or code expired. Contact webmaster for details' => 'Wrong code or code expired. Contact webmaster for details',
  ...
  'Wrong or expired confirmation code' => 'Wrong or expired confirmation code',
  'Wrong parameters passed' => 'Wrong parameters passed',
  ...
  'Xtream Code Lines' => 'Xtream Code Lines',
  'Xtream Codes Lines' => 'Xtream Codes Lines',
  'Year' => 'Year',
  'Years' => 'Years',
  'Yes' => 'Yes',
  ...
  'You can get this pass from the Google Authenticator mobile app.' => 'You can get this pass from the Google Authenticator mobile app.',
  ...
  'You can use user specific placeholders here %user.*% eg.: %user.user_id%, %user.login%, %user.email% etc.' => 'You can use user specific placeholders here %user.*% eg.: %user.user_id%, %user.login%, %user.email% etc.',
  ...
  'You have not any payments associated with country yet.' => 'You have not any payments associated with country yet.',
  'You have not any refunds associated with country yet.' => 'You have not any refunds associated with country yet.',
  ...
  'Your Auto-Login Link Has Expired...' => 'Your Auto-Login Link Has Expired...',
  'Your BIC
...
Up to 20 digits',
  ...
  'Your Client ID
        You can get it under Companay Settings -> Client ID' => 'Your Client ID
        You can get it under Companay Settings -> Client ID',
...
a confirmation email will be sent to you at this address',
  'Your Email Address was confirmed!  %sLogin%s to continue.' => 'Your Email Address was confirmed!  %sLogin%s to continue.',
...
Your account is \'example\'',
  ...
  'Your app’s shared secret' => 'Your app’s shared secret',
  ...
  'Your content  should not be public.
            ...
            content on Spaces.' => 'Your content  should not be public.
            Please restrict public access to your files
            and ensure you can not access it directly from DigitalOcean.
            aMember use Access Key and Secret Key to generate links with
            authentication token for users to provide access them to your
  ...
  'Your content  should not be public.
            ...
            authentication token for users to provide access them to your
            content on Wasabi.' => 'Your content  should not be public.
            Please restrict public access to your files
            and ensure you can not access it directly from Wasabi.
            aMember uses Access Key and Secret Key to generate links with
            authentication token for users to provide access them to your
  ...
  'Your content on Backblaze should be private.
            ...
            authentication token for users to provide access them to your
            content on Backblaze.' => 'Your content on Backblaze should be private.
            Please use only Private Buckets on Backblaze to store content.
            aMember use Key ID and Application Key to generate links with
            authentication token for users to provide access them to your
  ...
  'Your permission is required' => 'Your permission is required',
...
if 0 - without limit',
  ...
  'have %s %d subscriptions to %s' => 'have %s %d subscriptions to %s',
  ...
  'last signin match signup date' => 'last signin match signup date',
  'last signin match signup date and time' => 'last signin match signup date and time',
  ...
  'link' => 'link',
  'link to your account' => 'link to your account',
  'list_id can\'t be empty' => 'list_id can\'t be empty',
  'login' => 'login',
  'manage' => 'manage',
  'min' => 'min',
  'month' => 'month',
  ...
  'not agree to %s' => 'not agree to %s',
  'not share same signup IP with other users' => 'not share same signup IP with other users',
  'not subscribed to newsletter lists #' => 'not subscribed to newsletter lists #',
  ...
  'number of users per groups' => 'number of users per groups',
  ...
  'pCloud storage is not configured' => 'pCloud storage is not configured',
...
For example this IP is incorrect: 127.000.000.001',
  'share same signup IP with other users' => 'share same signup IP with other users',
  'showing %s records' => 'showing %s records',
  'showing records %s–%s from %s' => 'showing records %s–%s from %s',
  'signature required' => 'signature required',
  'spent %s %s' => 'spent %s %s',
  'status was not success' => 'status was not success',
  'subscribed to newsletter lists #' => 'subscribed to newsletter lists #',
  'super' => 'super',
  'there is not such affiliate' => 'there is not such affiliate',
...
in case of several discount rules is applicalable to same invoice - max discount will be used' => 'this discount will be applied to each item that present in condition
In case of discount is more than total of item - discount will be completely ignored
if user use coupon with purchase - max discount will be used,
in case of several discount rules is applicalable to same invoice - max discount will be used',
  'this field is required' => 'this field is required',
...
',
  ...
  'year' => 'year',
  'you can upload your files here' => 'you can upload your files here',
